...
class Questions(models.Model):
    ...
    question = models.CharField("Вопрос", max_length=200, blank=False)
    linkOfPicture = models.ImageField("Картинка к вопросу", upload_to='question_foto', blank=True, null=True)
    rightAnswer = models.CharField("Ответ", max_length=50, blank=False)
    ...
    aboutQuestion = models.CharField("Описание вопроса", max_length=1500, blank=False)
    link = models.CharField("Источник информации", max_length=50, blank=False)
    themeOfQuestion = models.CharField("Тема", max_length=50, blank=False)
    questionCategory = models.CharField("Категория", max_length=50, blank=False)
    sectionOfQuestion = models.CharField("Раздел", max_length=30, blank=False)
